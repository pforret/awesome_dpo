...
### Created by Peter Forret ( pforret ) on 2023-12-22
...
readonly script_created="2023-12-22"
readonly run_as_root=-1 # run_as_root: 0 = don't check anything / 1 = script MUST run as root / -1 = script MAY NOT run as root
readonly script_description="Manage Awesome list in Markdown"
## some initialisation
action=""
script_prefix=""
script_basename=""
...
choice|1|action|action to perform|deploy,install,check,env,update
